...
#include "../include/Video.h"
 ...
 void create_ui (CustomData *data, GtkWidget *window, GtkWidget *VideoBox) {
	...
	gtk_box_pack_start(GTK_BOX(VideoBox), main_box, TRUE, TRUE, 0);	
...
int VideoMain(GtkWidget *window, GtkWidget *VideoBox, char filepath[]){
	...
	g_object_set (data.playbin, "uri", "file:///home/lascelle/Videos/Sample2.mp4", NULL);
	...
	/* Create the GUI */
	create_ui (&data, window, VideoBox);
